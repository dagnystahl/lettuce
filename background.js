chrome.runtime.onMessage.addListener(function(imgs) {
    ...
    imageAnalyzerToken.then(function(result) {
        xhr.open("GET", `https://api.us-south.visual-recognition.watson.cloud.ibm.com/instances/675a71a2-5fd5-4a83-b41d-cf753b3cd12c/v3/classify?url=${imgs.image}&version=2018-03-19`);
